      ...
      success:function(result){
        ...
        if(result.totalItem==0){
          ...
          jQuery.each(result.data, function(arrKey,arrVal){
            ...
            html+='<li><a class="aa-cartbox-img" href="#"><img src="'+PRODUCT_IMAGE+'/'+arrVal.image+'" alt="img"></a><div class="aa-cartbox-info"><h4><a href="#">'+arrVal.name+'</a></h4><p> '+arrVal.qty+' * Rp.  '+arrVal.price+'</p></div></li>';
          });
         
        }
        html+='<li><span class="aa-cartbox-total-title">Total</span><span class="aa-cartbox-total-price">Rp. '+totalPrice+'</span></li>';
        console.log(html);
...
function deleteCartProduct(pid,size,color,attr_id){
  ...
  //jQuery('#total_price_'+attr_id).html('Rp. '+qty*price);
