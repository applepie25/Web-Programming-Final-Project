            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="aa-banner-area">
                        <a href="#"><img src="{{asset('front_assets/img/year-end-sale.png')}}"
                ...
                <div class="aa-support-area">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="aa-support-single">
                            ...
                            <P>Garansi Uang Kembali 100% Jika Barang Tidak Sesuai Deskripsi</P>
                        </div>
                    </div>
                    <!-- single support -->
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="aa-support-single">
                            ...
                            <h4>SUPPORT 24/7</h4>
                            <P>Mengalami Kesulitan Saat Memilih Barang? Hubungi Admin Kami</P>
                        </div>
                    </div>
                </div>
            </div>
