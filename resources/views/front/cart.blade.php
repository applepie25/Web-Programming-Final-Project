                                    ...
                                    <tbody>
                                        ...
                                        <tr id="cart_box{{$data->attr_id}}">
                                            ...
                                            <td><a href="{{url('product/'.$data->slug)}}"><img
                                                        src="{{asset('storage/media/'.$data->image)}}" alt="img"></a>
                                            </td>
                                            ...
                                            <td>Rp. {{$data->price}}</td>
                                            <td><input id="qty{{$data->attr_id}}" class="aa-cart-quantity" type="number"
                                                    value="{{$data->qty}}"
                                                    onchange="updateQty('{{$data->pid}}','{{$data->size}}','{{$data->color}}','{{$data->attr_id}}','{{$data->price}}')">
                                            </td>
                                            <td id="total_price_{{$data->attr_id}}">Rp. {{$data->price*$data->qty}}</td>
                                        </tr>
                                        @endforeach
                                        <tr>
                                            <td colspan="6" class="aa-cart-view-bottom">
                                                ...
                                                <a class="aa-cartbox-checkout aa-primary-btn"
                                                    href="{{url('/checkout')}}"><input class="aa-cart-view-btn"
