                        ...
                        <div class="aa-header-top-area">
                            ...
                            <div class="aa-header-top-left">
                                ...
                                <div class="cellphone hidden-xs">
                                    <p><span class="fa fa-phone"></span>089665898902</p>
                                </div>
                                <!-- / cellphone -->
                            </div>
                            <!-- / header top left -->
                        ...
                        <div class="aa-header-bottom-area">
                            ...
                            <div class="aa-logo">
                                ...
                                <a href="{{url('/')}}">
                                    ...
                                    <p>keibs<strong>Shop</strong> <span>Your Gaming Gear Partner</span></p>
                                </a>
                                <!-- img based logo -->
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a class="aa-cartbox-img" href="#"><img
                                                    src="{{asset('storage/media/'.$cartItem->image)}}" alt="img"></a>
                                            <div class="aa-cartbox-info">
                                                <h4><a href="#">{{$cartItem->name}}</a></h4>
                                                <p>{{$cartItem->qty}} * Rp. {{$cartItem->price}}</p>
                                            </div>
                                        </li>
                                        @endforeach
                                        <li>
                            ...
                            <div class="aa-search-box">
                                <form action="">
                                    <input type="text" id="search_str"
                                        placeholder="Search here ex. 'keyboard mechanical' ">
                                    <button type="button" onclick="funSearch()"><span
                                    ...
                                    <div class="aa-footer-widget">
                                        <div class="aa-footer-widget">
                                            ...
                                            <address>
                                                ...
                                                <p><span class="fa fa-phone"></span>+6289665898902</p>
                                                <p><span class="fa fa-envelope"></span>keibsshop@gmail.com</p>
                                            </address>
