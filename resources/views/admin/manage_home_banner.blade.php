    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('home_banner.manage_home_banner_process')}}" method="post"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input id="btn_txt" value="{{$btn_txt}}" name="btn_txt" type="text"
                            ...
                            <div class="form-group">
                                ...
                                @if($image!='')
                                <a href="{{asset('storage/media/banner/'.$image)}}" target="_blank"><img width="100px"
                                        src="{{asset('storage/media/banner/'.$image)}}" /></a>
                                @endif
                            </div>
